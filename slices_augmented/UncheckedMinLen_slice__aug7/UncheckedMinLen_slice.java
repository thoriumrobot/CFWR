...
ToPositive(@Positive int l, Object v) {
    // :: error: (assignment)
    @Positive
    Object @MinLen(100) [] o = new Object[l + 1];
    @Positive
  ...
  void addToUnboundedIntRange(@IntRange(from = 0) int l, Object v) {
    ...
    protected static Long __cfwr_handle145(int __cfwr_p0) {
        short __cfwr_entry83 = null;
        if ((true | (-38L | 56.79f)) || false) {
    ...
    private Integer __cfwr_handle527(String __cfwr_p0, Character __cfwr_p1) {
        while (true) {
            while (true) {
            while (false) {
            try {
    ...
    protected Boolean __cfwr_helper13(int __cfwr_p0, float __cfwr_p1) {
        if (false || true) {
            char __cfwr_node81 = 'e';
        }
        if ((-92.83f << 'g') || ('w' >> false)) {
            if (true || (-22.38 % 198)) {
            try {
