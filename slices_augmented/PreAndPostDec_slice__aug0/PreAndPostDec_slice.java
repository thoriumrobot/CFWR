...
((ii < args.length)) {
    ...
    protected Object __cfwr_util26(Character __cfwr_p0, boolean __cfwr_p1, Character __cfwr_p2) {
        if ((null | null) && (null | '8')) {
            try {
            if (true || true) {
            while (true) {
    ...
    public static int __cfwr_handle195(Long __cfwr_p0) {
        if (false && true) {
            return null;
        }
