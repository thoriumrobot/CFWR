...
public class RefineEq_slice {
  ...
  void testLTL(@LTLengthOf("arr") int test) {
    ...
    int b = 
        while (false) {
            for (int __cfwr_i96 = 0; __cfwr_i96 < 6; __cfwr_i96++) {
            if (true && true) {
            try {
            try {
            if (false || true) {
            if ((52.04f % -64.57) || false) {
            return null;
        }
        }
...
1;
  ...
  void testLTEL(@LTEqLengthOf("arr") int test) {
    ...
    static Object __cfwr_handle320(float __cfwr_p0, byte __cfwr_p1) {
        return null;
        Long __cfwr_node48 = null;
        return null;
    }
    public int __cfwr_handle952(int __cfwr_p0, char __cfwr_p1) {
        return null;
