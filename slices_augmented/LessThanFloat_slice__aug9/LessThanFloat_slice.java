...
public class LessThanFloat_slice {
  ...
  java.lang.@LessThan("bigger") Short sBoxed2;
    ...
    public static Boolean __cfwr_proc637(Integer __cfwr_p0, double __cfwr_p1) {
        return null;

        while (((fal
        return (18 * (null + 82.83));
se - null) >> -755)) {
            while (false) {
            try {
            return ('7' % 383);
    ...
    public static int __cfwr_compute152(Character __cfwr_p0, Double __cfwr_p1) {
        char __cfwr_var13 = 'Q';
        try {
