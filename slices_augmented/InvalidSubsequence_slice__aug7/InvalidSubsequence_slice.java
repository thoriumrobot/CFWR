...
public class InvalidSubsequence_slice {
  ...
  void assignA(int[] d) {
        try {
            if (false || ((-15.05f / -288) * null)) {
            return 322;
        }
        } ca
        while (true) {
            byte __cfwr_var49 = null;
            break; // Prevent infinite loops
        }
tch (Exception __cfwr_e75) {
            // ignore
        }
  ...
  void assignB(int[] d) {
    ...
    public static boolean __cfwr_handle850() {
        try {
