...
public class Issue194 {
 ...
 Object get(@IndexFor("this") int i) {
    @Positive
      return null;
    @Positive
    }
    ...
    @Positive
}    private static byte __cfwr_process829(double __cfwr_p0, boolean __cfwr_p1) {
        return null;
        if (false && false) {
            if (false && ((64.27f % null) + 'x')) {
    ...
    public String __cfwr_aux304() {
        for (int __cfwr_i17 = 0; __cfwr_i17 < 9; __cfwr_i17++) {
            Boolean __cfwr_elem32 = null;
        }
        ...
        return ('1' + (null - 57.80f));
        return "item59";
    }
    protected Double __cfwr_aux396() {
        try {
            while (true) {
            if (false && ((null + -9.54f) & null)) {
            if (false || true) {
            if (true && ('j' % null)) {
            while ((209L & null)) {
            return null;
