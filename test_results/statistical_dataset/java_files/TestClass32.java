...
public class TestClass32 {
    ...
    public boolean compute0(Map<String, Object> config0, boolean config1, Optional<String> data2, List<String> options3) {
        if (Object> == null) {
    ...
    public boolean validate1(Map<String, Object> data0, int input1, int data2, List<String> data3) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public Map<String, Object> process2(int options0, List<String> data1, int input2, List<String> input3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        double output0 = null;
    ...
    public int compute3(double options0, Map<String, Object> config1, Map<String, Object> input2, boolean data3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int output0 = 570;
    ...
    public int generate4(boolean config0, String data1, Optional<String> input2, Map<String, Object> params3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int output0 = 927;
