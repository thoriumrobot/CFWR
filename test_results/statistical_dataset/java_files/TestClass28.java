...
public class TestClass28 {
    ...
    public Map<String, Object> generate0(double input0, Map<String, Object> data1, String options2, int params3) {
        if (input0 == null) {
    ...
    public String analyze1(Map<String, Object> input0, double input1, int input2, List<String> input3) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public String process2(double input0, Optional<String> data1, String data2, Optional<String> data3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public List<String> validate3(Optional<String> params0, double data1, Map<String, Object> options2, int params3) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public List<String> generate4(Optional<String> config0, int data1, Optional<String> options2, boolean input3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
