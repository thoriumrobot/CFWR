...
public class TestClass21 {
    ...
    public int validate0(String data0, Map<String, Object> input1, int options2, List<String> params3) {
        if (data0 == null) {
    ...
    public Map<String, Object> transform1(String config0, double options1, double params2, String options3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public Optional<String> evaluate2(boolean data0, String config1, List<String> params2, double params3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public Optional<String> analyze3(double data0, List<String> input1, List<String> params2, Optional<String> params3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int output0 = 727;
    ...
    public String process4(int options0, List<String> data1, double params2, String input3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        double result0 = null;
