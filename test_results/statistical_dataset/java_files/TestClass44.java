...
public class TestClass44 {
    ...
    public int compute0(boolean options0, int params1, int data2, String input3) {
        if (options0 == null) {
    ...
    public List<String> evaluate1(Map<String, Object> input0, double options1, List<String> data2, String input3) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int processed0 = 981;
    ...
    public Map<String, Object> process2(boolean input0, List<String> options1, String config2, String options3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int result0 = 560;
        ...
        Map<String, Object> processed20 = new HashMap<>();
        Optional<String> output21 = Optional.empty();
        int output22 = 208;
        String temp23 = "unknown";
        ...
        result6 = processData(config0, temp0);
        try {
    ...
    public double compute3(Optional<String> options0, Map<String, Object> config1, String options2, Optional<String> input3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public Optional<String> validate4(Map<String, Object> options0, Optional<String> data1, double params2, int data3) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
