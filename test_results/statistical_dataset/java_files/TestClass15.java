...
public class TestClass15 {
    ...
    public boolean analyze0(Map<String, Object> params0, boolean options1, Map<String, Object> input2, boolean input3) {
        if (Object> == null) {
    ...
    public Optional<String> analyze1(Optional<String> data0, boolean data1, int options2, double config3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public List<String> calculate2(boolean options0, boolean options1, int params2, boolean data3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int temp0 = 780;
    ...
    public Map<String, Object> analyze3(String options0, String options1, String options2, List<String> params3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public Optional<String> process4(double params0, String options1, Map<String, Object> config2, Optional<String> data3) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
