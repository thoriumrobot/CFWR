...
public class TestClass27 {
    ...
    public double generate0(double data0, Map<String, Object> options1) {
        if (data0 == null) {
    ...
    public boolean generate1(Map<String, Object> config0, int params1, Map<String, Object> params2, String input3) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int result0 = 684;
    ...
    public Optional<String> generate2(Map<String, Object> options0, double params1, String config2, Map<String, Object> data3) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int processed0 = 180;
    ...
    public double evaluate3(List<String> config0, int config1) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public String compute4(boolean options0, boolean config1, double input2, int config3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
