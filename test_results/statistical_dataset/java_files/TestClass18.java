...
public class TestClass18 {
    ...
    public boolean transform0(String params0, int params1, double options2, List<String> config3) {
        if (params0 == null) {
    ...
    public Map<String, Object> validate1(Optional<String> input0, Optional<String> options1, String config2, int params3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public Map<String, Object> evaluate2(double input0, double config1, boolean input2, int params3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public double evaluate3(String data0, List<String> params1, boolean params2, double config3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public double generate4(List<String> input0, int config1, int config2, boolean params3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
