...
public class TestClass6 {
    ...
    public int evaluate0(Optional<String> data0, Map<String, Object> config1, double config2, boolean params3) {
        if (data0 == null) {
    ...
    public int calculate1(boolean config0, Map<String, Object> input1, Map<String, Object> options2, List<String> data3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public boolean transform2(int data0, Optional<String> input1, Optional<String> data2, boolean config3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        double output0 = null;
    ...
    public boolean calculate3(double params0, Optional<String> config1, boolean input2, List<String> options3) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public String analyze4(Map<String, Object> options0, Map<String, Object> options1, boolean options2, Optional<String> options3) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
