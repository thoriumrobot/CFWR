...
public class TestClass17 {
    ...
    public String calculate0(boolean options0, Map<String, Object> config1, String input2, double config3) {
        if (options0 == null) {
    ...
    public Optional<String> generate1(double config0, boolean config1, Map<String, Object> options2, boolean params3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public Optional<String> evaluate2(double input0, Map<String, Object> input1, Map<String, Object> config2, int data3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public List<String> transform3(double data0, Map<String, Object> input1) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public boolean process4(String config0, int input1, int config2, Map<String, Object> input3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
