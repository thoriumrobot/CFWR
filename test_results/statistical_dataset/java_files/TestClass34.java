...
public class TestClass34 {
    ...
    public String generate0(Map<String, Object> params0, boolean data1, Optional<String> data2, Map<String, Object> config3) {
        if (Object> == null) {
    ...
    public List<String> calculate1(Map<String, Object> params0, String config1) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        boolean temp0 = false;
    ...
    public Optional<String> calculate2(double config0, double data1) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public double calculate3(double options0, boolean input1, String data2, double config3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        double output0 = null;
    ...
    public double calculate4(int options0, String options1, double options2, int params3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
