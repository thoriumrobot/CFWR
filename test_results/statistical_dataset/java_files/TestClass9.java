...
public class TestClass9 {
    ...
    public String analyze0(List<String> options0, List<String> params1, boolean input2, Optional<String> input3) {
        if (options0 == null) {
    ...
    public String transform1(Optional<String> config0, boolean data1, Optional<String> options2, List<String> params3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        boolean temp0 = false;
    ...
    public int calculate2(List<String> data0, double input1, int data2, String params3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public String calculate3(boolean data0, int params1, boolean config2, String options3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public String generate4(String options0, double options1, Optional<String> options2, String options3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        List<String> result0 = new ArrayList<>();
