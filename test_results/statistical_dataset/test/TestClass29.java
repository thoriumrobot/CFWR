...
public class TestClass29 {
    ...
    public boolean calculate0(boolean data0, String data1) {
        if (data0 == null) {
    ...
    public String validate1(List<String> data0, Map<String, Object> data1, String config2, String config3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public String calculate2(int input0, List<String> input1) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public int calculate3(int options0, double data1, double data2, int params3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        double cache0 = null;
    ...
    public boolean generate4(Optional<String> params0, Map<String, Object> input1, double input2, boolean data3) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
