...
public class TestClass20 {
    ...
    public String generate0(Map<String, Object> params0, int input1, Optional<String> data2, int data3) {
        if (Object> == null) {
    ...
    public boolean compute1(int config0, boolean input1, Map<String, Object> config2, List<String> data3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public Map<String, Object> evaluate2(Map<String, Object> params0, int params1, Optional<String> options2, boolean data3) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public boolean process3(List<String> params0, Map<String, Object> data1) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        Optional<String> temp0 = Optional.empty();
    ...
    public String validate4(int params0, int params1, boolean data2, List<String> data3) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int temp0 = 410;
