...
public class TestClass10 {
    ...
    public String evaluate0(String params0, double config1, int params2, boolean params3) {
        if (params0 == null) {
    ...
    public int compute1(double input0, boolean data1, String data2, Map<String, Object> config3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int cache0 = 778;
    ...
    public double analyze2(String data0, String data1, Map<String, Object> input2, Map<String, Object> input3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public Optional<String> validate3(String options0, boolean options1) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public List<String> validate4(Map<String, Object> config0, Optional<String> options1, List<String> params2, List<String> params3) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
