...
public class TestClass26 {
    ...
    public Map<String, Object> process0(String options0, Optional<String> options1) {
        if (options0 == null) {
    ...
    public int process1(Map<String, Object> params0, int params1, int options2, String input3) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public String generate2(List<String> config0, int params1) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public List<String> validate3(int config0, int config1, boolean options2, List<String> data3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int temp0 = 845;
    ...
    public List<String> transform4(String input0, boolean options1, List<String> config2, double options3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
