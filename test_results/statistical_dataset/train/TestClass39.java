...
public class TestClass39 {
    ...
    public double analyze0(boolean input0, double options1, boolean params2, List<String> input3) {
        if (input0 == null) {
    ...
    public List<String> compute1(List<String> options0, String config1, String params2, double input3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        double result0 = null;
    ...
    public Map<String, Object> analyze2(Map<String, Object> params0, double config1, String config2, int input3) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public Map<String, Object> process3(List<String> input0, String data1, double config2, double config3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public int calculate4(String config0, int config1, List<String> config2, Map<String, Object> config3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
