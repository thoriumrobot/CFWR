...
public class TestClass48 {
    ...
    public String evaluate0(boolean config0, String data1, String config2, String input3) {
        if (config0 == null) {
    ...
    public List<String> analyze1(boolean options0, double options1, Optional<String> data2, double data3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public double calculate2(double data0, int params1, Map<String, Object> data2, int options3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        boolean temp0 = true;
    ...
    public Optional<String> calculate3(int input0, List<String> input1, String data2, String data3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public Map<String, Object> transform4(Map<String, Object> config0, int input1, boolean data2, int config3) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
