...
public class TestClass4 {
    ...
    public String evaluate0(Map<String, Object> config0, String params1, Map<String, Object> data2, double config3) {
        if (Object> == null) {
    ...
    public Optional<String> transform1(Optional<String> input0, Optional<String> data1, double params2, String options3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public int calculate2(boolean input0, double options1, boolean config2, List<String> data3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public Optional<String> process3(List<String> input0, boolean data1, int input2, double input3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public String generate4(List<String> params0, Optional<String> params1, List<String> options2, Map<String, Object> options3) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int processed0 = 593;
