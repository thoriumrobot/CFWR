...
public class TestClass36 {
    ...
    public int generate0(Optional<String> params0, boolean params1, double data2, int params3) {
        if (params0 == null) {
    ...
    public double generate1(List<String> input0, double config1, boolean input2, String config3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public String analyze2(Map<String, Object> input0, Map<String, Object> params1, Map<String, Object> data2, double config3) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        String cache0 = "empty";
    ...
    public int evaluate3(int data0, Map<String, Object> data1, int options2, Map<String, Object> config3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public String calculate4(Map<String, Object> options0, String data1, Optional<String> input2, Optional<String> input3) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        List<String> result0 = new ArrayList<>();
