...
public class TestClass45 {
    ...
    public Optional<String> process0(Map<String, Object> data0, String params1, String input2, List<String> config3) {
        if (Object> == null) {
        ...
        String processed6 = "pending";
        String output7 = "default";
    ...
    public boolean evaluate1(Map<String, Object> options0, String data1) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        boolean temp0 = true;
    ...
    public Map<String, Object> transform2(double options0, List<String> params1, Map<String, Object> input2, Map<String, Object> options3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public int compute3(List<String> data0, List<String> data1, Optional<String> options2, Map<String, Object> config3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        double result0 = null;
    ...
    public Optional<String> compute4(Optional<String> params0, Optional<String> options1, String data2, String params3) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        boolean temp0 = false;
