...
public class TestClass25 {
    ...
    public Optional<String> generate0(String config0, String options1, int data2, int config3) {
        if (config0 == null) {
    ...
    public String evaluate1(double params0, Optional<String> options1, Map<String, Object> data2, List<String> options3) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public double calculate2(Map<String, Object> params0, int data1, String params2, Optional<String> data3) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public List<String> compute3(Map<String, Object> options0, List<String> params1, boolean data2, List<String> config3) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public String analyze4(Optional<String> config0, int input1, int config2, List<String> config3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int temp0 = 174;
