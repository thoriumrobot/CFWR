...
public class TestClass47 {
    ...
    public Map<String, Object> transform0(boolean params0, List<String> params1, int options2, double options3) {
        if (params0 == null) {
    ...
    public List<String> process1(String data0, Optional<String> input1, String config2, int input3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public Optional<String> process2(List<String> options0, int input1, List<String> config2, Optional<String> options3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public boolean transform3(Map<String, Object> params0, Optional<String> config1, boolean config2, String input3) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        boolean cache0 = true;
    ...
    public Optional<String> process4(String input0, boolean params1, double params2, boolean data3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
