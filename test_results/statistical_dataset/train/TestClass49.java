...
public class TestClass49 {
    ...
    public Map<String, Object> transform0(String input0, String data1, boolean input2, boolean params3) {
        if (input0 == null) {
    ...
    public String analyze1(double input0, boolean options1, Optional<String> config2, Optional<String> params3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public Map<String, Object> generate2(boolean data0, Map<String, Object> config1, int params2, Optional<String> params3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public double validate3(int options0, List<String> config1, String data2, int input3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public List<String> process4(List<String> input0, int options1, int config2, boolean config3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
