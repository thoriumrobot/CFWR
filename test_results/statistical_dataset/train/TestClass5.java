...
public class TestClass5 {
    ...
    public List<String> compute0(List<String> config0, Map<String, Object> data1, Optional<String> input2, Optional<String> config3) {
        if (config0 == null) {
    ...
    public Optional<String> analyze1(List<String> params0, boolean input1, int input2, Map<String, Object> data3) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public int validate2(int config0, String config1, Map<String, Object> params2, boolean input3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public boolean generate3(String config0, double data1) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        double result0 = null;
    ...
    public List<String> transform4(List<String> params0, String input1, Map<String, Object> params2, String options3) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        List<String> result0 = new ArrayList<>();
