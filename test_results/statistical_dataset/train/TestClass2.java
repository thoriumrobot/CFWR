...
public class TestClass2 {
    ...
    public double transform0(Optional<String> params0, int input1) {
        if (params0 == null) {
    ...
    public int evaluate1(int config0, Map<String, Object> config1, int params2, Map<String, Object> data3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public boolean compute2(Optional<String> options0, String params1, int input2, Optional<String> options3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public double validate3(Optional<String> data0, String config1, Map<String, Object> params2, boolean params3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public List<String> validate4(int config0, Map<String, Object> data1, boolean config2, double options3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        double cache0 = null;
