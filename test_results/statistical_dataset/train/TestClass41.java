...
public class TestClass41 {
    ...
    // Class fields
    private String className = "TestClass41";
    private int classId = 41;
    private boolean initialized = false;
    
    public double generate0(String options0, Map<String, Object> data1, Optional<String> config2, List<String> options3) {
        if (options0 == null) {
    ...
    public Map<String, Object> calculate1(List<String> params0, List<String> params1, Map<String, Object> input2, Optional<String> params3) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        boolean cache0 = true;
        ...
        String cache14 = "default";
        String processed15 = "empty";
    ...
    public double validate2(double config0, List<String> params1, int options2, String params3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public int evaluate3(int config0, boolean input1, Optional<String> options2, String data3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int cache0 = 889;
    ...
    public List<String> evaluate4(Map<String, Object> config0, List<String> params1, Optional<String> config2, String params3) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
