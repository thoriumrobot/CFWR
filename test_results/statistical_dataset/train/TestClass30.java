...
public class TestClass30 {
    ...
    public List<String> calculate0(Map<String, Object> input0, double config1, String config2, String params3) {
        if (Object> == null) {
    ...
    public Map<String, Object> process1(int data0, double options1, Map<String, Object> params2, int config3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public String generate2(double data0, Map<String, Object> params1, Map<String, Object> options2, int params3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public Optional<String> compute3(boolean options0, boolean options1, String data2, String config3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        boolean temp0 = true;
    ...
    public List<String> transform4(int input0, boolean data1, List<String> params2, int options3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
