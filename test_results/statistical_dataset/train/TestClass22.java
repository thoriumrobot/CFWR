...
public class TestClass22 {
    ...
    public Optional<String> compute0(Optional<String> params0, Map<String, Object> options1, double options2, Optional<String> params3) {
        if (params0 == null) {
    ...
    public Optional<String> calculate1(boolean input0, Optional<String> input1) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public List<String> validate2(Optional<String> input0, List<String> options1, int input2, Map<String, Object> options3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public Map<String, Object> generate3(int params0, String params1) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public List<String> validate4(Optional<String> data0, List<String> options1) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int result0 = 724;
