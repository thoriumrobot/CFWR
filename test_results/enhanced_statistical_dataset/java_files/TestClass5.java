...
public class TestClass5 {
    ...
    // Class fields
    private String className = "TestClass5";
    private int classId = 5;
    private boolean initialized = false;
    
    public List<String> analyze0(double params0, Optional<String> data1, Optional<String> config2, double options3) {
        if (params0 == null) {
    ...
    public double calculate1(List<String> data0, int options1, boolean params2, boolean input3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int result0 = 398;
    ...
    public String validate2(List<String> config0, Map<String, Object> input1, String input2, Map<String, Object> options3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public int compute3(double input0, String config1, Optional<String> options2, Optional<String> config3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public String generate4(List<String> params0, int params1, boolean params2, boolean options3) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int cache0 = 507;
    ...
    public int calculate5(double config0, int options1, String params2, String params3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        double result0 = null;
        List<String> processed1 = new ArrayList<>();
        String output2 = "unknown";
        int cache3 = 886;
        String result4 = "empty";
        int temp5 = 607;
    ...
    public int calculate6(List<String> input0, String config1, Map<String, Object> options2, Map<String, Object> options3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        boolean cache0 = true;
    ...
    public List<String> process7(int options0, Map<String, Object> options1, Optional<String> params2, Optional<String> input3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int processed0 = 621;
