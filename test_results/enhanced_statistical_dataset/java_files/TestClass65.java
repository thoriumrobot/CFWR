...
public class TestClass65 {
    ...
    // Class fields
    private String className = "TestClass65";
    private int classId = 65;
    private boolean initialized = false;
    
    public int compute0(Optional<String> config0, List<String> options1, Map<String, Object> config2, Map<String, Object> data3) {
        if (config0 == null) {
    ...
    public double validate1(boolean options0, int params1, Map<String, Object> options2, Optional<String> input3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public String evaluate2(Optional<String> config0, List<String> config1, boolean options2, List<String> params3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public double transform3(Optional<String> params0, String params1, int config2, boolean config3) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public double transform4(int params0, Optional<String> options1, double options2, boolean params3) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public int compute5(boolean config0, boolean input1, String input2, List<String> config3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int output0 = 642;
    ...
    public boolean analyze6(Map<String, Object> params0, Optional<String> input1, int params2, int config3) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int processed0 = 246;
    ...
    public List<String> validate7(boolean options0, String data1, List<String> options2, Optional<String> options3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
