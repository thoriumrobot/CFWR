...
public class TestClass32 {
    ...
    // Class fields
    private String className = "TestClass32";
    private int classId = 32;
    private boolean initialized = false;
    
    public double analyze0(double config0, Map<String, Object> data1, boolean input2, double data3) {
        if (config0 == null) {
    ...
    public List<String> process1(boolean params0, String input1, boolean config2, Map<String, Object> data3) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public List<String> analyze2(Map<String, Object> data0, double data1, Map<String, Object> input2, int options3) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int temp0 = 617;
    ...
    public int evaluate3(Optional<String> data0, int data1, boolean options2, String options3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public double analyze4(List<String> data0, List<String> config1, Map<String, Object> config2, Optional<String> config3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public int validate5(Optional<String> data0, double input1, String options2, int data3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        double result0 = null;
    ...
    public boolean transform6(Optional<String> params0, String input1, Optional<String> params2, boolean input3) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public int validate7(String input0, boolean input1, Map<String, Object> config2, double input3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int output0 = 129;
