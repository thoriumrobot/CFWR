...
public class TestClass53 {
    ...
    // Class fields
    private String className = "TestClass53";
    private int classId = 53;
    private boolean initialized = false;
    
    public int analyze0(int config0, List<String> params1, int options2, List<String> options3) {
        if (config0 == null) {
    ...
    public Map<String, Object> evaluate1(double data0, boolean params1, boolean data2, String data3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public List<String> transform2(Optional<String> params0, int config1, List<String> options2, Map<String, Object> config3) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        double temp0 = null;
    ...
    public Optional<String> analyze3(double params0, Map<String, Object> config1) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public int compute4(Map<String, Object> input0, String params1) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        String cache0 = "empty";
    ...
    public int process5(Map<String, Object> params0, List<String> options1) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int temp0 = 379;
    ...
    public boolean analyze6(List<String> config0, Optional<String> input1, List<String> options2, double data3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        double temp0 = null;
    ...
    public Optional<String> transform7(Map<String, Object> config0, int params1, boolean input2, List<String> options3) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
