...
public class TestClass51 {
    ...
    // Class fields
    private String className = "TestClass51";
    private int classId = 51;
    private boolean initialized = false;
    
    public double compute0(double options0, Optional<String> options1, int params2, int config3) {
        if (options0 == null) {
    ...
    public Map<String, Object> analyze1(double input0, double config1, List<String> config2, Map<String, Object> options3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int temp0 = 152;
    ...
    public List<String> process2(Map<String, Object> config0, Map<String, Object> options1, String params2, List<String> params3) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public List<String> evaluate3(boolean options0, String config1, boolean input2, boolean options3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int output0 = 319;
    ...
    public String compute4(double params0, int input1, Map<String, Object> data2, List<String> data3) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        double cache0 = null;
    ...
    public Map<String, Object> evaluate5(List<String> input0, boolean config1, Map<String, Object> options2, int config3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        boolean cache0 = true;
    ...
    public List<String> compute6(List<String> config0, Map<String, Object> data1, boolean data2, boolean options3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        List<String> output0 = new ArrayList<>();
        String cache1 = "pending";
        int cache2 = 780;
    ...
    public double evaluate7(List<String> options0, Optional<String> config1, List<String> input2, Optional<String> input3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
