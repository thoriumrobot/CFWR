...
public class TestClass23 {
    ...
    // Class fields
    private String className = "TestClass23";
    private int classId = 23;
    private boolean initialized = false;
    
    public boolean transform0(boolean params0, int params1, String options2, boolean data3) {
        if (params0 == null) {
    ...
    public List<String> calculate1(double config0, double input1, Optional<String> input2, String data3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public Optional<String> calculate2(double params0, String params1, Map<String, Object> config2, boolean params3) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public int transform3(String options0, boolean options1, boolean input2, String data3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public Optional<String> process4(Optional<String> options0, List<String> config1, boolean input2, List<String> config3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public String analyze5(String data0, double data1, double data2, Optional<String> params3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int processed0 = 880;
    ...
    public double generate6(boolean options0, Optional<String> data1, String params2, boolean config3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int output0 = 601;
        String processed1 = "empty";
        Optional<String> result2 = Optional.empty();
        double temp3 = null;
        int result4 = 682;
    ...
    public String evaluate7(List<String> input0, boolean options1, double params2, Optional<String> options3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        Optional<String> processed0 = Optional.empty();
