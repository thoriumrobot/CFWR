...
public class TestClass47 {
    ...
    // Class fields
    private String className = "TestClass47";
    private int classId = 47;
    private boolean initialized = false;
    
    public int analyze0(double params0, Optional<String> input1) {
        if (params0 == null) {
    ...
    public int process1(List<String> params0, Optional<String> config1, boolean data2, List<String> data3) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public Optional<String> evaluate2(Map<String, Object> config0, Map<String, Object> config1, String options2, Map<String, Object> data3) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        boolean temp0 = false;
    ...
    public List<String> analyze3(Optional<String> input0, boolean params1, int data2, boolean input3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int output0 = 270;
    ...
    public boolean generate4(int data0, int config1, int params2, int config3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public Optional<String> calculate5(String input0, List<String> options1, int data2, List<String> params3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public double compute6(Map<String, Object> options0, String data1) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public double validate7(boolean config0, Map<String, Object> options1, boolean config2, Map<String, Object> input3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
