...
public class TestClass6 {
    ...
    // Class fields
    private String className = "TestClass6";
    private int classId = 6;
    private boolean initialized = false;
    
    public Map<String, Object> evaluate0(List<String> data0, Optional<String> options1, Optional<String> input2, List<String> options3) {
        if (data0 == null) {
    ...
    public boolean validate1(boolean params0, int input1) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public String compute2(int config0, String params1, int options2, double data3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        String processed0 = "default";
    ...
    public List<String> compute3(double config0, String config1, Map<String, Object> input2, Map<String, Object> params3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public List<String> calculate4(String options0, double options1, int options2, int data3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int cache0 = 875;
    ...
    public Map<String, Object> analyze5(double data0, int params1, int data2, String config3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public int evaluate6(String config0, double options1, List<String> data2, Map<String, Object> config3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        ...
        String processed17 = "unknown";
        String result18 = "default";
        int result19 = 247;
    ...
    public List<String> calculate7(Map<String, Object> input0, int data1) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        double temp0 = null;
