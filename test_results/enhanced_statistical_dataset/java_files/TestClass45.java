...
public class TestClass45 {
    ...
    // Class fields
    private String className = "TestClass45";
    private int classId = 45;
    private boolean initialized = false;
    
    public double compute0(String config0, double input1) {
        if (config0 == null) {
    ...
    public boolean calculate1(String options0, Map<String, Object> data1) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public List<String> evaluate2(String options0, List<String> input1, Optional<String> input2, List<String> config3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public String calculate3(boolean options0, List<String> params1, int config2, String options3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int cache0 = 539;
    ...
    public double compute4(int config0, String config1, String input2, Optional<String> config3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        double temp0 = null;
    ...
    public Optional<String> process5(Optional<String> input0, String input1) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        double result0 = null;
    ...
    public Optional<String> evaluate6(String config0, boolean config1, Optional<String> input2, String params3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public boolean process7(Optional<String> params0, boolean options1, List<String> params2, Map<String, Object> input3) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
