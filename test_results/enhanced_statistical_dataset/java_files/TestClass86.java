...
public class TestClass86 {
    ...
    // Class fields
    private String className = "TestClass86";
    private int classId = 86;
    private boolean initialized = false;
    
    public String calculate0(List<String> config0, List<String> options1, Optional<String> params2, double config3) {
        if (config0 == null) {
    ...
    public Map<String, Object> transform1(String input0, Map<String, Object> data1, boolean options2, String input3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public boolean calculate2(int input0, int params1) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int output0 = 181;
    ...
    public boolean process3(String input0, List<String> params1, Map<String, Object> config2, int options3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        boolean temp0 = true;
    ...
    public Map<String, Object> calculate4(String input0, List<String> data1, String params2, boolean options3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        String temp0 = "empty";
    ...
    public boolean calculate5(double params0, String config1) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int cache0 = 77;
    ...
    public Map<String, Object> compute6(Optional<String> input0, List<String> data1, String params2, boolean options3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public boolean compute7(int params0, List<String> params1, boolean input2, List<String> options3) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        double cache0 = null;
