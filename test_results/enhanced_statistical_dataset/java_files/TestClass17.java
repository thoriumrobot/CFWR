...
public class TestClass17 {
    ...
    // Class fields
    private String className = "TestClass17";
    private int classId = 17;
    private boolean initialized = false;
    
    public boolean generate0(int data0, double data1, int params2, int options3) {
        if (data0 == null) {
    ...
    public int calculate1(Map<String, Object> params0, String config1, String config2, double options3) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int result0 = 291;
    ...
    public boolean evaluate2(boolean config0, List<String> data1, String config2, boolean params3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public Map<String, Object> compute3(boolean input0, List<String> options1, Map<String, Object> options2, double params3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        double result0 = null;
    ...
    public String process4(String input0, List<String> config1, boolean input2, Map<String, Object> params3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public Optional<String> validate5(boolean config0, double input1) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public int transform6(Optional<String> options0, int options1, String options2, int config3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int cache0 = 271;
    ...
    public String transform7(int data0, double config1, int data2, Map<String, Object> params3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        double temp0 = null;
