...
public class TestClass96 {
    ...
    // Class fields
    private String className = "TestClass96";
    private int classId = 96;
    private boolean initialized = false;
    
    public Map<String, Object> generate0(boolean options0, Map<String, Object> data1) {
        if (options0 == null) {
    ...
    public Optional<String> calculate1(Optional<String> params0, List<String> options1, String params2, double config3) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        boolean temp0 = true;
    ...
    public String process2(double params0, Optional<String> input1, int data2, String input3) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public List<String> analyze3(double input0, int input1) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        double output0 = null;
    ...
    public boolean calculate4(Optional<String> data0, List<String> params1, Map<String, Object> data2, boolean data3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public int validate5(String data0, boolean options1, int data2, Optional<String> params3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public int validate6(Optional<String> config0, int data1, int options2, int data3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public Map<String, Object> analyze7(Optional<String> options0, String input1, int data2, Map<String, Object> config3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        Map<String, Object> temp0 = new HashMap<>();
