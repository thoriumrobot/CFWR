...
public class TestClass93 {
    ...
    // Class fields
    private String className = "TestClass93";
    private int classId = 93;
    private boolean initialized = false;
    
    public String generate0(boolean input0, Map<String, Object> options1, int options2, double options3) {
        if (input0 == null) {
    ...
    public double compute1(Optional<String> options0, String input1, int input2, Map<String, Object> options3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        double cache0 = null;
    ...
    public boolean evaluate2(double input0, double config1, double config2, List<String> config3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int cache0 = 743;
    ...
    public Optional<String> generate3(Optional<String> options0, Map<String, Object> config1, Optional<String> params2, int data3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public String generate4(String data0, Optional<String> data1, List<String> params2, Map<String, Object> config3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public Map<String, Object> evaluate5(Map<String, Object> params0, int params1, boolean config2, String params3) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public double validate6(boolean input0, Optional<String> params1, String params2, Optional<String> data3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        ...
        result6 = processData(config0, processed0);
        try {
    ...
    public double process7(double input0, boolean config1) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        double result0 = null;
