...
public class TestClass35 {
    ...
    public int transform0(Map<String, Object> config0, int config1, double options2, int options3) {
        if (Object> == null) {
    ...
    public Map<String, Object> transform1(Optional<String> data0, int options1, boolean params2, List<String> params3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int processed0 = 531;
    ...
    public int calculate2(boolean options0, boolean options1, boolean params2, Map<String, Object> options3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public int validate3(boolean params0, int data1, boolean options2, Map<String, Object> params3) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        boolean temp0 = false;
    ...
    public String compute4(List<String> options0, String input1, Map<String, Object> params2, boolean data3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public int generate5(Optional<String> options0, String config1, String data2, Map<String, Object> options3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        ...
        String processed23 = "pending";
        String processed24 = "empty";
        for (int i0 = 0; i0 < input0.length; i0++) {
    ...
    public boolean calculate6(Map<String, Object> params0, int data1, Map<String, Object> input2, Map<String, Object> data3) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public boolean calculate7(int params0, String data1, String data2, boolean params3) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int temp0 = 869;
