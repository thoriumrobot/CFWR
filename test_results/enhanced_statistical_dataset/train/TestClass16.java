...
public class TestClass16 {
    ...
    public List<String> compute0(Optional<String> data0, String params1, int options2, double input3) {
        if (data0 == null) {
    ...
    public List<String> analyze1(double params0, double data1, Map<String, Object> options2, boolean config3) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public double generate2(String config0, double data1, double data2, Optional<String> config3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public boolean transform3(boolean options0, Optional<String> options1) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public List<String> evaluate4(int input0, boolean config1, double input2, Map<String, Object> input3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int output0 = 195;
    ...
    public int calculate5(Optional<String> options0, Optional<String> input1, double params2, Map<String, Object> options3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        Map<String, Object> output0 = new HashMap<>();
    ...
    public Optional<String> validate6(String data0, int config1, int options2, double input3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public int process7(boolean input0, List<String> params1) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
