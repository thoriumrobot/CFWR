...
public class TestClass41 {
    ...
    public List<String> validate0(double input0, Map<String, Object> params1, double options2, int params3) {
        if (input0 == null) {
    ...
    public Map<String, Object> compute1(double params0, List<String> data1) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public String process2(int options0, boolean config1, boolean options2, Optional<String> data3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public List<String> process3(boolean input0, double options1, double params2, int config3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public List<String> process4(Optional<String> config0, double config1, int config2, String input3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public boolean transform5(List<String> data0, int input1, boolean input2, boolean params3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public boolean compute6(String data0, double config1) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public int evaluate7(Optional<String> options0, List<String> data1, List<String> params2, List<String> params3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
