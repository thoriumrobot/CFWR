...
public class TestClass42 {
    ...
    public double analyze0(String data0, boolean options1, int input2, String options3) {
        if (data0 == null) {
    ...
    public String evaluate1(String params0, Optional<String> config1, Optional<String> data2, String params3) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public int compute2(Optional<String> data0, List<String> params1, String params2, List<String> input3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        double cache0 = null;
    ...
    public double evaluate3(double config0, Optional<String> config1) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public Optional<String> transform4(int config0, Map<String, Object> input1, double input2, boolean input3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public List<String> calculate5(String config0, String data1, double options2, String params3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public boolean validate6(Map<String, Object> input0, Optional<String> options1, List<String> options2, Map<String, Object> options3) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public List<String> compute7(int config0, Optional<String> params1, int options2, Optional<String> data3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        Optional<String> processed0 = Optional.empty();
