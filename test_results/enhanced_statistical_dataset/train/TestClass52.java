...
public class TestClass52 {
    ...
    // Class fields
    private String className = "TestClass52";
    private int classId = 52;
    private boolean initialized = false;
    
    public double transform0(double data0, Optional<String> config1, Map<String, Object> input2, boolean config3) {
        if (data0 == null) {
    ...
    public boolean compute1(Map<String, Object> config0, String config1) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public List<String> compute2(List<String> options0, Map<String, Object> data1, boolean options2, List<String> options3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public Map<String, Object> validate3(double params0, List<String> params1, boolean config2, String input3) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        double temp0 = null;
    ...
    public Optional<String> process4(Optional<String> data0, double params1, boolean options2, List<String> input3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public String analyze5(int params0, int options1) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public boolean validate6(double data0, Map<String, Object> params1, int data2, Map<String, Object> input3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public boolean calculate7(boolean options0, String params1, double config2, int config3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        boolean temp0 = false;
