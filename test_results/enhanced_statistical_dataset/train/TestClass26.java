...
public class TestClass26 {
    ...
    // Class fields
    private String className = "TestClass26";
    private int classId = 26;
    private boolean initialized = false;
    
    public double evaluate0(String options0, int params1) {
        if (options0 == null) {
    ...
    public boolean evaluate1(String options0, boolean params1) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        double cache0 = null;
    ...
    public boolean compute2(boolean data0, int input1, boolean options2, String params3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public List<String> transform3(Map<String, Object> config0, Optional<String> options1, Map<String, Object> options2, double params3) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        ...
        int temp16 = 438;
        boolean temp17 = false;
        Optional<String> cache18 = Optional.empty();
        Map<String, Object> temp19 = new HashMap<>();
        Optional<String> processed20 = Optional.empty();
        int temp21 = 182;
    ...
    public List<String> validate4(String config0, String data1, String config2, double input3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        double cache0 = null;
    ...
    public String validate5(boolean input0, double params1, int input2, double config3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        double result0 = null;
        ...
        double cache18 = null;
        int cache19 = 368;
        List<String> output20 = new ArrayList<>();
    ...
    public Map<String, Object> transform6(String data0, String data1) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public Optional<String> compute7(Map<String, Object> options0, List<String> options1, int params2, List<String> data3) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        boolean output0 = false;
