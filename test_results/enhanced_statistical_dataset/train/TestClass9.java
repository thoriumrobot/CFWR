...
public class TestClass9 {
    ...
    // Class fields
    private String className = "TestClass9";
    private int classId = 9;
    private boolean initialized = false;
    
    public List<String> analyze0(int data0, int params1, double input2, boolean input3) {
        if (data0 == null) {
    ...
    public Optional<String> compute1(boolean params0, String config1, String params2, Optional<String> config3) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public boolean transform2(Optional<String> data0, int params1, List<String> input2, Map<String, Object> data3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public Map<String, Object> process3(String options0, int params1) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        boolean cache0 = true;
    ...
    public int process4(List<String> data0, int data1, double params2, List<String> data3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int result0 = 285;
    ...
    public double analyze5(List<String> config0, List<String> params1, String params2, String config3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int cache0 = 563;
    ...
    public String generate6(double params0, Optional<String> params1) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int processed0 = 538;
    ...
    public Map<String, Object> process7(Optional<String> params0, int options1, Map<String, Object> options2, int config3) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        boolean temp0 = true;
