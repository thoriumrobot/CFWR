...
public class TestClass24 {
    ...
    public boolean generate0(Optional<String> options0, String data1) {
        if (options0 == null) {
    ...
    public List<String> compute1(List<String> data0, List<String> input1, String input2, List<String> options3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public List<String> compute2(String data0, String config1, int params2, String input3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public int transform3(Map<String, Object> data0, List<String> data1, Map<String, Object> input2, boolean config3) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int result0 = 362;
    ...
    public int generate4(Optional<String> options0, int data1, String data2, boolean config3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        boolean cache0 = true;
    ...
    public Optional<String> transform5(Optional<String> config0, Map<String, Object> data1, double params2, boolean input3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public int transform6(List<String> options0, boolean params1, boolean data2, boolean data3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public Optional<String> evaluate7(double input0, int params1, Map<String, Object> data2, Map<String, Object> input3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        double result0 = null;
