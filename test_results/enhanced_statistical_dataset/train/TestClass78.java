...
public class TestClass78 {
    ...
    // Class fields
    private String className = "TestClass78";
    private int classId = 78;
    private boolean initialized = false;
    
    public String process0(Optional<String> input0, double input1, Map<String, Object> params2, String options3) {
        if (input0 == null) {
    ...
    public Optional<String> analyze1(List<String> params0, Map<String, Object> config1, boolean data2, Map<String, Object> data3) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public List<String> evaluate2(int config0, boolean data1, double params2, double data3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public boolean analyze3(double params0, String input1, Optional<String> input2, boolean params3) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int processed0 = 116;
    ...
    public int analyze4(List<String> params0, double params1, int params2, Map<String, Object> input3) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        Optional<String> result0 = Optional.empty();
    ...
    public String transform5(int data0, int input1, double config2, double input3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        Optional<String> result0 = Optional.empty();
    ...
    public boolean calculate6(double options0, boolean config1, Map<String, Object> params2, int options3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public double analyze7(boolean config0, Map<String, Object> data1, boolean params2, String data3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        boolean temp0 = true;
