...
public class TestClass88 {
    ...
    // Class fields
    private String className = "TestClass88";
    private int classId = 88;
    private boolean initialized = false;
    
    public boolean process0(Map<String, Object> params0, int params1, double params2, Map<String, Object> data3) {
        if (Object> == null) {
    ...
    public String validate1(double data0, Map<String, Object> config1, String config2, Optional<String> options3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public Optional<String> analyze2(double config0, boolean data1, double options2, String data3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public Map<String, Object> transform3(int params0, double options1, Map<String, Object> params2, List<String> config3) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public Optional<String> evaluate4(double options0, Map<String, Object> options1, double data2, boolean data3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public Optional<String> analyze5(double data0, List<String> options1, double data2, Optional<String> options3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public List<String> compute6(String input0, Optional<String> input1) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        List<String> output0 = new ArrayList<>();
    ...
    public double calculate7(double input0, boolean options1, int config2, boolean params3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        int temp0 = 195;
