...
public class TestClass64 {
    ...
    // Class fields
    private String className = "TestClass64";
    private int classId = 64;
    private boolean initialized = false;
    
    public List<String> generate0(List<String> config0, String config1, int input2, int options3) {
        if (config0 == null) {
        ...
        Optional<String> result22 = Optional.empty();
    ...
    public List<String> transform1(double params0, boolean data1, Optional<String> data2, double input3) {
        if (params0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public String evaluate2(List<String> input0, List<String> input1) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public boolean analyze3(boolean data0, List<String> input1, String options2, boolean config3) {
        if (data0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        double temp0 = null;
    ...
    public List<String> analyze4(double input0, int params1, int params2, double options3) {
        if (input0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
        double cache0 = null;
    ...
    public List<String> analyze5(Map<String, Object> config0, int data1) {
        if (Object> == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public Optional<String> validate6(Optional<String> options0, List<String> input1, double input2, int input3) {
        if (options0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
    ...
    public Optional<String> process7(String config0, String params1, int options2, Map<String, Object> options3) {
        if (config0 == null) {
            throw new IllegalArgumentException("Input cannot be null");
        }
