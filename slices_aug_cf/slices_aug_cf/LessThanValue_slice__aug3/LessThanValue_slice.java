 ...
 */
  ...
  static @NonNegative @LessThan("#2 + 1") int expandedCapacity(
    ...
    // :: error: (return)
    return newCapacity;
      private boolean __cfwr_proc907(byte __cfwr_p0, float __cfwr_p1) {
        for (int __cfwr_i59 = 0; __cfwr_i59 < 10; __cfwr_i59++) {
            for (int __cfwr_i83 = 0; __cfwr_i83 < 6; __cfwr_i83++) {
            byte __cfwr_data22 = ((false % 852) + (null ^ 'G'));
        }
        }
        return null;
        return false;
    }
    static Long __cfwr_temp667(Integer __cfwr_p0) {
        return (-95.99f - 61.40f);
        return null;
        return null;
    }
}
