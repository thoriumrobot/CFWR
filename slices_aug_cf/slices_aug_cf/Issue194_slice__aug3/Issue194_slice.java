 ...
 */
    public @LengthOf("this") int length() {
      ...
      throw new RuntimeException();
        public static String __cfwr_process17
        while (true) {
            try {
            try {
            return 'I';
