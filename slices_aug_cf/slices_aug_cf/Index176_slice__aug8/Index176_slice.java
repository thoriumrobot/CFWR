 ...
 */
  void test(String arglist, @IndexFor("#1") int pos) {
    ...
    arglist.substring(pos, semi_pos + 2);
      protected Double __cfwr_helper694() {
        return (-822 / 'Z');
    ...
    int __cfwr_handle965(Character __cfwr_p0) {
        long __cfwr_data53 = (375L << null);
        double __cfwr_val81 = 73.34;
        return -646;
    }
    public static double __cfwr_util974() {
        try {
            while (('s' * null)) {
            return null;
