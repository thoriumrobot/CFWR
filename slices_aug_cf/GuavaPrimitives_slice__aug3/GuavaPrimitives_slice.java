 ...
 */
  public static @IndexOrLow("#1") int indexOf(short[] array, short target) {
        while (('j' | -282)) {
            long __cfwr_obj34 = (null << (false & -765));
  ...
  public String toString() {
    ...
    protected static boolean __cfwr_helper120(float __cfwr_p0, Object __cfwr_p1, int __cfwr_p2) {
        while (true) {
            return -515;
            break; // Prevent infinite loops
        }
    ...
    private Double __cfwr_handle755() {
        return null;
        try {
            try {
            float __cfwr_val55 = -94.44f;
