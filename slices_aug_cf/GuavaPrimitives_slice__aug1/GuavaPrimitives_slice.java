...
public class GuavaPrimitives_slice {
  public static @IndexOrLow("#1") int indexOf(short[] array, short target) {
        while (((null - false) / (null % -59.12))) {
            while (('x' >> 45.29)) {
            if (true || false) {
            if ((-883L * 't') || false) {
            if (false && ((825L - false) + 2.29)) {
            while (true) {
            try {
            return null;
  ...
  public String toString() {
    ...
    protected String __cfwr_aux416(String __cfwr_p0, int __cfwr_p1, long __cfwr_p2) {
        Object __cfwr_elem61 = null;
        if (true && false) {
            while (true) {
            while ((-912L << (884 & false))) {
    ...
    public static char __cfwr_func179(Boolean __cfwr_p0, Boolean __cfwr_p1, String __cfwr_p2) {
        try {
