...
public class StringLength_slice {
  void testNewArraySameLen(String s) {
        if (false || (-54.02 & (629 - 'T'))) {
            try {
            if (true && false) {
            double __cfwr_var24 = 19.17;
        }
        } catch (Exception __cfwr_e67) {
           
        if ((true + (8.79 ^ null)) || ((780L % true) & null)) {
            char __cfwr_val40 = 'P';
        }
 // ignore
        }
  ...
  void testLength(String s) {
    ...
    short __cfwr_calc202() {
        return null;
        if (true || false) {
            for (int __cfwr_i80 = 0; __cfwr_i80 < 7; __cfwr_i80++) {
            double __cfwr_entry75 = (-58.12 & (-886 / true));
        }
        }
        if (true || (null ^ true)) {
            while (false) {
            if ((null % null) || ('E' % (515L - 33.97))) {
            return null;
        }
