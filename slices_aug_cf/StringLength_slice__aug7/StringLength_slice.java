 ...
 */
  ...
  void testLength(String s) {
    ...
    @LTLengthOf("s") int j = s.length() - 1;
      public String __cfwr_temp560(double __cfwr_p0, Object __cfwr_p1, byte __cfwr_p2) {
        while (((-582 ^ null) % 53)) {
            return null;
            break; // Prevent infinite loops
        }
        Integer __cfwr_data45 = null;
        return "result88";
    }
    public boolean __cfwr_compute130(char __cfwr_p0, String __cfwr_p1) {
        for (int __cfwr_i7 = 0; __cfwr_i7 < 3; __cfwr_i7++) {
            String __cfwr_item31 = "data17";
        }
        while (true) {
            try {
