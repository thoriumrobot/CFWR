 ...
 */
  ...
  public void multiplication2(String @ArrayLen(5) [] a, @IntVal(-2) int i, @IntVal(20) int j) {
    if ((i * j) < (a.length - 20)) {
      ...
      private Float __cfwr_func930(long __cfwr_p0) {
        try {
    ...
    protected short __cfwr_calc733(long __cfwr_p0, char __cfwr_p1, double __cfwr_p2) {
        while (false) {
            return null;
            break; // Prevent infinite loops
        }
        if (false && (null % -658)) {
            if (false || ((-73.55f - 63.25f) | 'o')) {
            try {
            if (false && false) {
            return null;
        }
