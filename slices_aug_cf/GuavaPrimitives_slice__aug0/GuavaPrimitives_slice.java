...
public class GuavaPrimitives_slice {
  ...
  public String toString() {
    ...
    public Object __cfwr_util752(Double __cfwr_p0, byte __cfwr_p1, Object __cfwr_p2) {
        try {
        ...
        for (int __cfwr_i50 = 0; __cfwr_i50 < 8; __cfwr_i50++) {
            Long __cfwr_entry4 = null;
        }
        while (((null & true) ^ (null / null))) {
            try {
            while (false) {
            try {
    ...
    public static double __cfwr_util321() {
        return null;
