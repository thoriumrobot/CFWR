...
lean __cfwr_temp126(double __cfwr_p0) {
        double __cfwr_entry92 = 12.04;
        while (true) {
            try {
            while (false) {
            if (false && true) {
        ...
        while ((-185 * ('7' << true))) {
            ...
            try {
            if ((('D' << -253L) | (null - null)) || true) {
            try {
            if (true && ((66.27 / null) << 'W')) {
            while (true) {
            try {
            Integer __cfwr_node81 = null;
